...
def update(event=None):
    ...
    def updatewithid():
        ...
        lab6=tk.Label(idtk,text="IMDB ID of the movie whose record you want to update:",font=('Cascadia Mono SemiLight',14),bg='#42c8f5')
...
def search():
    ...
    def searchwithname():
        ...
        nametk.configure(bg='#42c8f5')
        nametk.title('Searching Record using name')
